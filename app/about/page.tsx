  ...
  return (
    <div className='p-10 bg-[url("https://i0.wp.com/backgroundabstract.com/wp-content/uploads/edd/2022/02/vecteezy_abstract-geometric-background-illustration-in-flat-style_-e1656068792936.jpg?resize=600%2C450&ssl=1")] bg-no-repeat bg-cover min-h-screen text-black '>
        <div className='text-center space-y-5'>
          <p className='font-semibold text-4xl inline-block border-b-4 border-purple-700 '>ABOUT ME</p>
          ...
          <div className='p-5 space-y-5'>
            ...
            <div className=''>
              <ul className='grid grid-cols-4 gap-6'>
                <button className='bg-slate-700/10 px-4 py-2 rounded space-x-10 hover:bg-purple-300 hover:rounded'>HTML</button>
                <button className='bg-slate-700/10 px-4 py-2 rounded space-x-10 hover:bg-purple-300 hover:rounded'>CSS</button>
                <button className='bg-slate-700/10 px-4 py-2 rounded space-x-10 hover:bg-purple-300 hover:rounded'>REACT</button>
                <button className='bg-slate-700/10 px-4 py-2 rounded space-x-10 hover:bg-purple-300 hover:rounded'>GITHUB</button>
                <button className='bg-slate-700/10 px-4 py-2 rounded space-x-10 hover:bg-purple-300 hover:rounded'>GIT</button>
                <button className='bg-slate-700/10 px-4 py-2 rounded space-x-10 hover:bg-purple-300 hover:rounded'>TAILWIND</button>
                <button className='bg-slate-700/10 px-4 py-2 rounded space-x-10 hover:bg-purple-300 hover:rounded'>MongoDB</button>
              </ul>
            </div>
          </div>
        </div>
