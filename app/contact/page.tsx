...
const page = () => {
  ...
  return (
    <div className=''>
          {/* top */}
        <div className='mt-10'>
          <p className='text-gray-200 text-sm uppercase justify-self-center'>get in touch</p>
          <div className='space-y-4'>
          <h1 className='text-3xl capitalize justify-self-center'>contact <span className='text-teal-300'>me</span></h1>
          <p className='text-center text-lg w-150 justify-self-center'> i am currently open to full-time, contract or part-time opportunities in Front End Development </p>
          </div>
          {/* grid */}
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-5 mt-10 bg-white/10 p-10 m-40'>
          ...
          {/* right */}
      <div className=''>
        <form action="contact-form" className='space-y-3 '>
        ...
        <div className='flex justify-center mt-5'>
          <Button text={'submit'} className={'lg:px-20 px-6 py-2 cursor-pointer rounded-lg uppercase font-bold bg-teal-300 hover:bg-teal-500 text-center lg:w-fit text-black '} onClick={handleToggle}/>
        </div>
