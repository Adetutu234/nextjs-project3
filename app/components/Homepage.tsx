...
const Homepage = () => {
  ...
  return (
      <div className='relative '>
          <div className='min-h-[calc(100vh-80px)] text-center p-28 space-y-10 bg-[url("https://files.123freevectors.com/wp-content/original/121373-light-grey-abstract-texture-background-image.jpg")] bg-no-repeat bg-cover rounded-2xl '>
            ...
            <div className='absolute top-40 bg-white p-2'>
              <div className='grid grid-rows-4 space-y-3 shadow-2xl drop-shadow-2xl cursor-pointer'>
