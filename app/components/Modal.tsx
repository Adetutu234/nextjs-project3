...
const Modal = ({handleToggle}:any) => {
  return (
    <div className='inset-0 backdrop-blur-xs fixed text-black'>
      <div className='bg-white border-1 text-center relative mx-auto top-[35%] lg:w-150 w-85 lg:p-10 p-5 space-y-3'>
        <XCircle size={25} onClick={handleToggle} className='absolute right-1 top-1 hover:text-teal-300'/>
